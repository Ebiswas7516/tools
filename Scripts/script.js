function addToCart(id,tax){
    ...
    if(currDeliveryCost === 0)
        document.getElementById("delivery-cost").innerHTML = "100$"

    if(currShippingCost === 0)
        document.getElementById("shipping-cost").innerHTML = "1000$"
    ...
    const currIntotal = currPrice + taxVal + parseInt("100") + parseInt("1000")
